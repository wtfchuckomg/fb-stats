...
const SECTIONS = {
  ...
  '5A': {
    East:['Basehor-Linwood', 'De Soto', 'JC Harmon', 'KC Piper', 'KC Turner', 'KC Washington', 'Leavenworth', 'St. James Academy',
  ...
  '6A': {
    East:['Gardner-Edgerton', 'KC Wyandotte', 'Lawrence', 'Olathe East', 'Olathe North', 'Olathe Northwest', 'Olathe South', 'Olathe West',
